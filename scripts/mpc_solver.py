...
class KinematicMPC:
    def __init__(
        ...
        # Warm-start storage — speed states seeded to min_speed so first
        # solve starts feasible w.r.t. the lower-bound constraint X[3,:] >= min_speed.
        self._X_prev = np.zeros((5, N + 1))
        self._X_prev[3, :] = min_speed
